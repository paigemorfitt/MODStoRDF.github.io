...
<table>
  ...
  <tr>
    ...
    <td><a href="mods.relateditem_note.md" class ="magic-button" title="[definition]">relatedItem/note</a></td>
    <td>N/A</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
		...
		<td><a href="rdf.rdau.p60527.md" class ="magic-button" title="[definition]">rdau:P60527</a></td>
  </tr>
   <tr>
    <td><a href="date.encoded.md" class ="magic-button" title="[definition]">date_encoded</a></td>
    <td><a href="mods.originInfo_dateOther.md" class ="magic-button" title="[definition]">originInfo/dateOther</a></td>
    <td><a href="rdf.dcterms.created.md" class ="magic-button" title="[definition]">dcterms:created</a></td>
  </tr>  
   <tr>
		<td><a href="date_issued.md" class ="magic-button" title="[definition]">date_issued</a></td>
		<td><a href="mods.originInfo_dateIssued.md" class ="magic-button" title="[definition]">originInfo/dateIssued</a></td>
		<td><a href="rdf.dcterms.issued.md" class ="magic-button" title="[definition]">dcterms:issued</a></td>
  </tr>
  <tr>
